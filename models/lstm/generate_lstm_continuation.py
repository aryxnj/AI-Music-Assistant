...
##############################
MODEL_PATH = "lstm_model.h5"                # The trained model
INPUT_MIDI_PATH = "input_midis/input-3.mid" # The monophonic MIDI file to continue
OUTPUT_MIDI_PATH = "output_midis/output-3-generated.mid"

NUM_GENERATION_STEPS = 16  # How many new notes to generate
TEMPERATURE = 0.4          # Lower => more predictable
TOP_K = 5                  # Restrict sampling to top-5 tokens
MAX_INTERVAL = 12          # Prevent leaps larger than one octave
...
########################################################
def top_k_sample(logits, k=TOP_K):
    """
...
def clamp_pitch(prev_pitch, new_pitch, max_interval=MAX_INTERVAL):
    """
...
def generate_continuation(
    ...
    for _ in range(num_steps):
        ...
        # Sample from the top-k distribution
        sampled_pitch = top_k_sample(logits, k=TOP_K)
        ...
        clamped_pitch = clamp_pitch(last_pitch, sampled_pitch, MAX_INTERVAL)
