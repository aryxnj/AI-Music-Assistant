...
* **Datasets**  
  * _Mono-MIDI Transposition Dataset_ – MIT Licence :contentReference[oaicite:0]{index=0}  
  * _4-Bars Monophonic Melodies Dataset_ (Zenodo 13369389) – CC BY-4.0 :contentReference[oaicite:1]{index=1}  
